...
public class RecyclerAdapterPreviewPlan extends RecyclerView.Adapter<RecyclerAdapterPreviewPlan.ViewHolder> {
    ...
    private GetPlanModel trainingModel;
    ...
    public GetPlanModel getTrainingModel() {
        return trainingModel;
    }

    public void setTrainingModel(GetPlanModel trainingModel) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if (position == 0) {
            ...
            if (trainingModel != null) {
                ...
                descriptionTraning.setText(trainingModel.getTraining().getDescription());
                ...
                createdDate.setText(trainingModel.getTraining().getCreationDate());
            }
            if (mUserModel != null) {
