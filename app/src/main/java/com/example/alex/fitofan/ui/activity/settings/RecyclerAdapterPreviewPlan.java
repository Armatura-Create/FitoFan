...
public class RecyclerAdapterPreviewPlan extends RecyclerView.Adapter<RecyclerAdapterPreviewPlan.LinearSet> {

    //Предоставляет ссылку на представления, используемые в RecyclerView
    private SettingActivity trainingActivity;
    private SettingsModel model;

    public RecyclerAdapterPreviewPlan(SettingActivity trainingActivity) {
